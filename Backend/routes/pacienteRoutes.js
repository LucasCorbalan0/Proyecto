...
// Obtener lista de todos los pacientes (sin protección para búsqueda en médicos)
...
router.get(
  "/:id_paciente/historia-clinica",
  pacienteController.getHistoriaClinica
);
// Crear o actualizar historia clínica
router.put(
  "/:id_paciente/historia-clinica",
  pacienteController.actualizarHistoriaClinica
);
...
// Obtener todas las cirugías del paciente
router.get("/cirugias/:id_paciente", pacienteController.getCirugias);
...
router.get(
  "/disponibilidad/:id_medico",
  pacienteController.getDisponibilidadMedicos
);
