  ...
  useEffect(() => {
    const fetchDatosPersonales = async () => {
      try {
        ...
        if (!idPaciente || !token) {
          throw new Error(
            "No se encontró el ID del paciente o el token de autenticación"
          );
        }

        const responsePaciente = await apiClient.get(
          `/pacientes/datos/${idPaciente}`,
          {
            headers: {
        ...
        const responseHistoria = await apiClient.get(
          `/pacientes/${idPaciente}/historia-clinica`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        if (responsePaciente.data && responseHistoria.data) {
          ...
          const rawPaciente =
            responsePaciente.data.data !== undefined
              ? responsePaciente.data.data
              : responsePaciente.data;
          const rawHistoria =
            responseHistoria.data.data !== undefined
              ? responseHistoria.data.data
              : responseHistoria.data;

          const pacienteData = Array.isArray(rawPaciente)
            ? rawPaciente[0]
            : rawPaciente || {};
          const historiaData = Array.isArray(rawHistoria)
            ? rawHistoria[0]
            : rawHistoria || {};
          ...
          const datosActualizados = {
            ...
            grupoSanguineo:
              historiaData?.tipo_sangre || historiaData?.grupo_sanguineo || "",
            alergias:
              historiaData?.alergias_conocidas || historiaData?.alergias || "",
            condicionesCronicas:
              historiaData?.comorbilidades_cronicas ||
              historiaData?.condiciones_cronicas ||
              "",
            medicacionActual:
              historiaData?.medicacion_habitual ||
              historiaData?.medicacion_actual ||
              "",
            antecedentesQuirurgicos:
              historiaData?.antecedentes_quirurgicos || "",
            contactoEmergenciaNombre:
              historiaData?.contacto_emergencia_nombre || "",
            contactoEmergenciaTelefono:
              historiaData?.contacto_emergencia_telefono || "",
          };
    ...
    try {
      ...
      if (updated) {
        setDatosPersonales((prev) => ({
          ...
          direccion: updated.direccion || prev.direccion,
    ...
    <div className="space-y-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-900 font-medium">
                {datosPersonales.obraSocial || "No especificado"}
              </p>
            </div>
            <div>
            ...
            <div className="md:col-span-2">
              ...
              {isEditing ? (
                ...
                <p className="text-gray-900 font-medium">
                  {datosPersonales.direccion || "No especificado"}
                </p>
              )}
            </div>
          </div>
            ...
            {isEditingMedical ? (
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    value={datosPersonales.condicionesCronicas}
                    onChange={(e) =>
                      setDatosPersonales((prev) => ({
                        ...prev,
                ...
                <div>
                  ...
                  <input
                    value={datosPersonales.medicacionActual}
                    onChange={(e) =>
                      setDatosPersonales((prev) => ({
                        ...prev,
                ...
                <div>
                  ...
                  <input
                    value={datosPersonales.antecedentesQuirurgicos}
                    onChange={(e) =>
                      setDatosPersonales((prev) => ({
                        ...prev,
                      ...
                      try {
                        ...
                        const payload = {
                          ...
                          comorbilidades_cronicas:
                            datosPersonales.condicionesCronicas || null,
                          medicacion_habitual:
                            datosPersonales.medicacionActual || null,
                          antecedentes_quirurgicos:
                            datosPersonales.antecedentesQuirurgicos || null,
                        };
                        const updated = await api.actualizarHistoriaClinica(
                          idPaciente,
                          payload
                        );
                        ...
                        setDatosPersonales((prev) => ({
                          ...prev,
                          grupoSanguineo:
                            updated.tipo_sangre || prev.grupoSanguineo,
                          alergias: updated.alergias_conocidas || prev.alergias,
                          condicionesCronicas:
                            updated.comorbilidades_cronicas ||
                            prev.condicionesCronicas,
                          medicacionActual:
                            updated.medicacion_habitual ||
                            prev.medicacionActual,
                          antecedentesQuirurgicos:
                            updated.antecedentes_quirurgicos ||
              ...
              <>
                <div>
                  ...
                  <p className="text-gray-900 font-medium">
                    {datosPersonales.grupoSanguineo || "No especificado"}
                  </p>
                </div>
                <div>
                  <label className="text-sm text-gray-500 mb-1 block">
                  ...
                  <p className="text-gray-900 font-medium">
                    {datosPersonales.alergias || "No especificado"}
                  </p>
                </div>
                <div>
                  <label className="text-sm text-gray-500 mb-1 block">
                  ...
                  <p className="text-gray-900 font-medium">
                    {datosPersonales.condicionesCronicas || "No especificado"}
                  </p>
                </div>
              </>
            )}
      ...
      <div className="mt-6 bg-white rounded-xl p-6 border border-gray-200">
        <div className="flex items-center justify-between mb-6">
          ...
          {!isEditingContacto ? (
            <button
              onClick={() => setIsEditingContacto(true)}
              className="px-4 py-2 text-blue-600 hover:bg-blue-50 rounded-lg text-sm font-medium transition-colors"
            >
              Editar
            </button>
          ...
          {isEditingContacto ? (
            <>
              <div>
                ...
                <input
                  value={datosPersonales.contactoEmergenciaNombre}
                  onChange={(e) =>
                    setDatosPersonales((prev) => ({
                      ...prev,
              ...
              <div>
                ...
                <input
                  value={datosPersonales.contactoEmergenciaRelacion}
                  onChange={(e) =>
                    setDatosPersonales((prev) => ({
                      ...prev,
              ...
              <div>
                ...
                <input
                  value={datosPersonales.contactoEmergenciaTelefono}
                  onChange={(e) =>
                    setDatosPersonales((prev) => ({
                      ...prev,
              ...
              <div className="md:col-span-3 flex gap-2 mt-2">
                    ...
                    try {
                      ...
                      const payload = {
                        contacto_emergencia_nombre:
                          datosPersonales.contactoEmergenciaNombre || null,
                        contacto_emergencia_telefono:
                          datosPersonales.contactoEmergenciaTelefono || null,
                      };
                      const updated = await api.actualizarHistoriaClinica(
                        idPaciente,
                        payload
                      ...
                      setDatosPersonales((prev) => ({
                        ...prev,
                        contactoEmergenciaNombre:
                          updated.contacto_emergencia_nombre ||
                          prev.contactoEmergenciaNombre,
                        contactoEmergenciaTelefono:
                          updated.contacto_emergencia_telefono ||
                          prev.contactoEmergenciaTelefono,
                      }));
                ...
                <button
                  onClick={() => setIsEditingContacto(false)}
                  className="px-4 py-2 border rounded-md"
                >
                  Cancelar
                </button>
            ...
            <>
              <div>
                ...
                <p className="text-gray-900 font-medium">
                  {datosPersonales.contactoEmergenciaNombre ||
                    "No especificado"}
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-900 font-medium">
                  {datosPersonales.contactoEmergenciaTelefono ||
                    "No especificado"}
                </p>
              </div>
            </>
